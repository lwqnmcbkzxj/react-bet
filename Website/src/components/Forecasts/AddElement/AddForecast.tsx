	...
	return (
		<form onSubmit={props.handleSubmit}>
			...
			<div className={s.groupedInputs}>
				{createField('bookmaker', Input, 'Букмекерская контора !!DROPDOWN HERE', {elements: ['1XСТАВКА', 'BETCITY', 'ЛигаСтавок']})}
				{createField('sport', Input, 'Вид спорта  !!DROPDOWN HERE', { elements: sports })}
			</div>


			{createField('championship', Input, 'Чемпионат', { elements: champinships })}
			{createField('teams', Input, 'Команды', { elements: teams })}
			<div className={s.groupedInputs}>
